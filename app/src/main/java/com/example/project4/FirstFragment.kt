...
class FirstFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val jokeType = resources.getStringArray(R.array.JokeType)
        val arrayAdapter = ArrayAdapter(requireContext(), R.layout.dropdown_item, jokeType)
        binding.jokeDropDown.setAdapter(arrayAdapter)
        return binding.root
